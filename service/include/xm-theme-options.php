...
function themeoptions_page() {
    ...
    $xm_qywx_secret = get_option('xm_qywx_secret');
    // 加载上传图片的js(wp自带)
            ...
            <ul class="content-wrapper">
                ...
                <li class="content-item">
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-content">
                            <label for="vip-style-1" class="vip-style"
                                   style="display: inline-block; width: 15px; height: 15px; background: url(<?php bloginfo('template_url'); ?>/static/images/vip.png) -147px -70px;"></label>
                            <input
                                    type="radio"
                                    id="vip-style-1"
                                    name="vip-style"
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-content">
                            ...
                            <input
                                    ...
                                    name="aside-count"
                                    value="1"
                                <?php if ((bool)$xm_options['aside_count']) {
                                    echo 'checked';
                                } ?>
                            >
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-content">
                            <textarea
                                    class="input-inner--textarea"
                                    name="sidebar-notice"
                                    rows="5"
                                    cols="100"
                            ><?php echo $xm_options['sidebar_notice']; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-content">
                            <textarea class="input-inner--textarea" name="footer-copyright" rows="7"
                                      cols="100"><?php echo $xm_options['footer_copyright']; ?></textarea>
                        </div>
                    </div>
                </li>
                <!-- 基本设置结束 -->
                ...
                <li class="content-item">
                    <div class="form-item">
                        ...
                        <div class="form-item-content">
                            <textarea class="input-inner--textarea" name="keywords" rows="3"
                                      cols="100"><?php echo $xm_options['keywords'] ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-content">
                            <textarea class="input-inner--textarea" name="description" rows="8"
                                      cols="100"><?php echo $xm_options['description'] ?></textarea>
                        </div>
                    </div>
                </li>
                <!-- SEO结束 -->
                ...
                <li class="content-item">
                    <div class="form-item">
                        ...
                        <div class="form-item-content">
                            <div class="input-inner">
                                <label for="banner-style-1" class="vip-style"
                                       style="display: inline-block; width: 200px; height: 90px; background: url(<?php bloginfo('template_url'); ?>/static/images/banner-style-1.png) no-repeat 0 0/100% 100%;"></label>
                                <input
                                        type="radio"
                                        id="banner-style-1"
                                        name="banner-style"
                                    ...
                                    ?>
                                >
                                <label for="banner-style-2" class="vip-style"
                                       style="display: inline-block; width: 200px; height: 90px; background: url(<?php bloginfo('template_url'); ?>/static/images/banner-style-2.png) no-repeat 0 0/100% 100%;"></label>
                                <input
                                        type="radio"
                                        id="banner-style-2"
                                        name="banner-style"
                        ...
                        <div class="form-item-group">
                            <div class="form-item">
                                ...
                                <div class="form-item-content">
                                    ...
                                    <p>
                                        <img src="<?php echo $xm_options['banner']['list'][$i]['path']; ?>"
                                             class="preview-img">
                                    </p>
                                </div>
                            </div>
                ...
                <li class="content-item">
                    ...
                    <!--                            <p>-->
                    <!--                                <img src="-->
                    <?php //echo $xm_options['favicon']; ?><!--" class="preview-img">-->
                    <!--                            </p>-->
                    <!--                        </div>-->
                    <!--                    </div>-->
                ...
                <li class="content-item">
                    <div class="form-item">
                        ...
                        <div class="form-item-content">
                            <textarea class="input-inner--textarea" name="login-css" rows="8"
                                      cols="100"><?php echo $xm_options['login_css']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-item">
                        <p class="form-item-title">全局公用css<br/>(不需要style标签):</p>
                        <div class="form-item-content">
                            <textarea class="input-inner--textarea" name="global-css" rows="8"
                                      cols="100"><?php echo $xm_options['global_css']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-item">
                        <p class="form-item-title">文章详情页css<br/>(不需要style标签):</p>
                        <div class="form-item-content">
                            <textarea class="input-inner--textarea" name="details-css" rows="8"
                                      cols="100"><?php echo $xm_options['details_css']; ?></textarea>
                        </div>
                    </div>
                </li>
                <!-- 自定义代码结束 -->
                ...
                <li class="content-item">
                    <div class="form-item">
                        <p class="form-item-title">是否启用：</p>
                        <div class="form-item-content">
                            <label for="qyweixin-notify-enable">开</label>
                            <input
                                    type="radio"
                                    id="qyweixin-notify-enable"
                                    name="qyweixin-notify"
                                    value="1"
                                <?php if ((bool)$xm_qywx_secret['qywx_notify_enabled']) {
                                    echo 'checked';
                                } ?>
                            >
                            <label for="qyweixin-notify-disable">关</label>
                            <input
                                    type="radio"
                                    id="qyweixin-notify-disable"
                                    name="qyweixin-notify"
                                    value="0"
                                <?php if ((bool)!$xm_qywx_secret['qywx_notify_enabled'] || !$xm_qywx_secret['qywx_notify_enabled']) {
                                    echo 'checked';
                                } ?>
                            >
                        </div>
                    ...
                    <div class="form-item">
                        <p class="form-item-title">企业微信ID：</p>
                        <input
                                type="text"
                                class="input-inner"
                                name="qywx_id"
                                value="<?php echo $xm_qywx_secret['qywx_id']; ?>"
                        >
                    </div>

                    <div class="form-item">
                        <p class="form-item-title">应用Secret：</p>
                        <input
                                type="text"
                                class="input-inner"
                                name="qywx_secret"
                                value="<?php echo $xm_qywx_secret['qywx_secret']; ?>"
                        >
                    </div>

                    <div class="form-item">
                        <p class="form-item-title">应用AgentId：</p>
                        <input
                                type="text"
                                class="input-inner"
                                name="qywx_agent_id"
                                value="<?php echo $xm_qywx_secret['qywx_agent_id']; ?>"
                        >
                    </div>

                    <div class="form-item">
                        <p class="form-item-title">用户ID：</p>
                        <input
                                type="text"
                                class="input-inner"
                                name="qywx_user_id"
...
function themeoptions_update() {
    ...
    update_option('xm_qywx_secret', stripslashes_deep(array(
        'qywx_notify_enabled' => $_POST['qyweixin-notify'],
        'qywx_id'             => $_POST['qywx_id'],
        'qywx_secret'         => $_POST['qywx_secret'],
        'qywx_agent_id'       => $_POST['qywx_agent_id'],
        'qywx_user_id'        => $_POST['qywx_user_id'],
    )));
}
