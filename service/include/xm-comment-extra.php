...
function get_browser_name($str)
{
    ...
    } elseif (preg_match('/iPad|iPhone/', $str)) {
        // iPad or iphone
    ...
    } elseif (preg_match('/Chrome|MetaSr/', $str)) {
        // chrome
